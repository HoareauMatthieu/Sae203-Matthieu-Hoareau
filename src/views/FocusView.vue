<template>
  <div class="p-8 pt-36">
    ...
    <h1 class="pt-9 font-Anton text-4xl sm:text-5xl lg:text-6xl">LAYLOW</h1>
    <p class="py-5 text-sm">Hip/Hop - Musique électronique</p>
    <h2 class="pt-3 font-Anton text-3xl">RAPPEUR <span class="text-red-400">NEXT</span>-GEN</h2>
    ...
    <h2 class="pt-3 font-Anton text-3xl">COUTEAUX <span class="text-red-400">SUISSE</span> ?</h2>
    <p class="py-5 text-base">
    ...
    <h2 class="pt-3 font-Anton text-3xl">DES <span class="text-red-400">STUDIOS</span> À LA <span class="text-red-400">SCÈNE</span></h2>
    <p class="py-5 text-base">
    ...
    <h3 class="py-6 text-center font-Anton text-lg">Laylow se produira le 23 mars à 15h30 sur la Scène 2</h3>
  </div>
</template>