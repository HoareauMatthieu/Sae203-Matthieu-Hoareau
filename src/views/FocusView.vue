<template>
  <div class="p-8 pt-36">
    ...
    <h2 class="pt-3 titreh2">COUTEAUX <span class="text-red-400">SUISSE</span> ?</h2>
    <p class="py-5 text-base">
    ...
    <h2 class="pt-3 titreh2">
      DES <span class="text-red-400">STUDIOS</span> À LA <span class="text-red-400">SCÈNE</span>
    </h2>
    <p class="py-5 text-base">
