<template>
    <div class="pt-52 p-10">
        ...
        <form>
          ...
          <h2 class="text-2xl font-Anton">Nouveau style</h2>
             <input type="text" class="p-2 border-2 dark:border-white border-red-400 bg-transparent   w-full rounded-md" placeholder="Ajouter un style musical" v-model='libelle' required />
            <bouton type="button" @click='createCat()' title="Création">
           envoyer
            </bouton>
            </div>
                         ...
                         <h2 class="text-2xl font-Anton pt-6">Liste des Catégories actuels</h2>                          
